...
function mushrooms() {
  var mushroom = 0;
  var addMushroom = document.getElementById("topping5");
...
function sausages() {
  var sausage = 0;
  var addsausage = document.getElementById("topping1");
...
function onions() {
  var onion = 0;
  var addonions = document.getElementById("topping2");
  if (addMushroom.checked === true) {
      onion = 130;
  }
...
function tikkaSaucee() {
  var tikkaSauce = 0;
  var addtikkaSauce = document.getElementById("topping3");
...
function mozarellaCheese() {
  var cheese = 0;
  var addmozarellaCheese = document.getElementById("topping4");
